...
class Ui_Downloading(object):
    ...
    def setupUi(self, Dialog):
        ...
        Dialog.resize(698, 424)
        Dialog.setStyleSheet("background-color: rgb(200, 129, 148);")
        self.comboBox = QtWidgets.QComboBox(Dialog)
        self.comboBox.setGeometry(QtCore.QRect(160, 130, 181, 41))
        self.comboBox.setStyleSheet("color: rgb(0,0,0);\n"
"font: 75 12pt \"Verdana\";")
        self.comboBox.setObjectName("comboBox")
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(160, 90, 151, 31))
        self.label.setStyleSheet("color: rgb(0, 0, 0);\n"
"font: 75 12pt \"Verdana\";")
        self.label.setObjectName("label")
        self.pushButton = QtWidgets.QPushButton(Dialog)
        self.pushButton.setGeometry(QtCore.QRect(160, 230, 211, 41))
...
"font: 75 11pt \"Verdana\";")
        ...
        self.label_2.setGeometry(QtCore.QRect(440, 80, 231, 201))
        self.label_2.setStyleSheet("image: url(../DICE/images/down1.png);")
