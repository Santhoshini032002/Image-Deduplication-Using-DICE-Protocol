...
from CSPHome import Ui_CSPHome
class Ui_CSP(object):
...
"font: 75 12pt \"Times New Roman\";")
        ...
        self.pushButton.setGeometry(QtCore.QRect(200, 320, 101, 41))
...
"color: rgb(255, 255, 255);")
        ...
        self.label_4.setGeometry(QtCore.QRect(420, 110, 211, 251))
        self.label_4.setStyleSheet("image: url(../DICE/images/csp.png);")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "CSP"))
        self.label.setText(_translate("Dialog", "        CSP Login"))
